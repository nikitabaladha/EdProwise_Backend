...
router.get("/sitemap.xml", async (req, res) => {
  try {
    ...
    const links = [
      ...
      {
        url: "/services/recruitment-services",
        changefreq: "monthly",
        priority: 0.8,
      },
      // procurement / goods
      ...
      {
        url: "/services/get-goods-services",
        changefreq: "monthly",
        priority: 0.8,
      },
      ...
      {
        url: "/community-connect/student-zone/{slug}",
        changefreq: "monthly",
        priority: 0.7,
      },
      {
        url: "/community-connect/educator-zone/{slug}",
        changefreq: "monthly",
        priority: 0.7,
      },
      {
        url: "/community-connect/student-zone/category-tag-related-blogs",
        changefreq: "monthly",
        priority: 0.7,
      },
      {
        url: "/community-connect/educator-zone/category-tag-related-blogs",
        changefreq: "monthly",
        priority: 0.7,
      },
      ...
      {
        url: "/terms-condition-for-seller",
        changefreq: "monthly",
        priority: 0.6,
      },
      ...
      {
        url: "/change-school-admin-password",
        changefreq: "monthly",
        priority: 0.5,
      },
      ...
      {
        url: "/payroll-module/employee-services/update-details",
        changefreq: "monthly",
        priority: 0.5,
      },
      {
        url: "/payroll-module/employee-services/attendance/mark-attendance",
        changefreq: "monthly",
        priority: 0.5,
      },
      {
        url: "/payroll-module/employee-services/attendance/apply-for-leave",
        changefreq: "monthly",
        priority: 0.5,
      },
      {
        url: "/payroll-module/employee-services/attendance/my-attendance-report",
        changefreq: "monthly",
        priority: 0.5,
      },
    ...
    const stream = new SitemapStream({
      hostname: process.env.FRONTEND_URL || "https://edprowise.com",
    });
