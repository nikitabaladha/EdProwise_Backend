...
const schoolaffiliationCertificateDir = "./Documents/SchoolaffiliationCertificate";
  ...
  fileFilter: (req, file, cb) => {
    ...
    if (file.fieldname === "profileImage") {
      ...
      if (mimeType && extName) {
        ...
        cb(new Error("Only JPEG, JPG, or PNG files are allowed for ProfileImage"));
      ...
      if (mimeType) {
        ...
        cb(
          ...
          new Error(
            ...
            "Only PDF files are allowed for school pan file"
