...
async function updateById(req, res) {
  try {
    ...
    const { error } = SubscriptionValidator.SubscriptionUpdateValidator.validate(req.body);
    if (error) {
    ...
    const updatedData = {
      ...
      subscriptionNoOfMonth: subscriptionNoOfMonth || existingSubscription.subscriptionNoOfMonth,
