...
const getGreetingTemplates = async (req, res) => {
  try {
    const { schoolId, academicYear, role } = req.query;
    ...
    // Fetch templates
    const templates = await GreetingsmsTemplate.find({
      schoolId,
      academicYear,
      role,
      isActive: true,
...
export default getGreetingTemplates;
