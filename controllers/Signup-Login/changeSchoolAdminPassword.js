...
async function sendPasswordUpdateEmail(
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: schoolEmail,
      subject: `${usersWithCredentials.userName}, Your Password Has Been Successfully Updated`,
      html: `
              <!DOCTYPE html>
                <html>
                <head>
                ...
                <div class="outer-div">
                    <div class="email-container">
                        ...
                        <!-- Main Content -->
                        <div class="content">
                            <p class="message fw-bold">Dear ${usersWithCredentials.userName},</p>
                            
                            <p class="message">You have recently updated the password for your ${
                              smtpSettings.mailFromName
                            } account.</p>
                            <p class="message">Admin of ${schoolName}, password has been successfully updated.</p>

                            <!-- User Details Box -->
                            <p class="message">The updated login details for ${usersWithCredentials.userName} are:  </p>
