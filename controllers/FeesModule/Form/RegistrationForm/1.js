...
// // //         return res.status(500).json({
// // //           hasError: true,
// // //           message: 'Payment URL configuration missing.',
// // //         });
// // //       }
...
// // //       // Use BACKEND_URL for callbacks, FRONTEND_URL for user redirects
// // //       const initiateData = {
// // //         key: process.env.EASEBUZZ_KEY,
// // //         txnid: txnId,
// // //         amount: amount,
...
// // //       console.log('Success Callback:', initiateData.surl);
// // //       console.log('Failure Callback:', initiateData.furl);
// // //       console.log('Frontend Success:', initiateData.udf6);
// // //       console.log('Frontend Failure:', initiateData.udf7);
...
// // //     // Handle offline payments (Cash/Cheque)
// // //     const paymentData = {
// // //       studentId,
// // //       schoolId,
// // //       academicYear,
...
// // //       return res.redirect(`${process.env.FRONTEND_URL}/payment/failure?error=invalid_hash`);
// // //     }
...
// // //       return res.redirect(`${process.env.FRONTEND_URL}/payment/failure?error=invalid_ids`);
// // //     }
...
// // //     res.redirect(`${process.env.FRONTEND_URL}/payment/failure?error=processing_error&message=${encodeURIComponent(err.message)}`);
// // //   }
// // // };
...
const handlePaymentSuccess = async (req, res) => {
  try {
    ...
    if (!isHashValid) {
      ...
      console.warn('  Hash verification failed, but proceeding for testing');
    ...
    const easebuzzId = data.easepayid;
