...
//         // Calculate feesPaid and concession based on SchoolFees
//         for (const payment of payments) {
//           if (!payment.cancelledDate) {
//             for (const feeItem of payment.feeItems) {
//               const paidAmount = feeItem.paid || 0;
//               if (paidAmount > 0) {
//                 installmentFeesPaid += paidAmount;
//                 concession += paidAmount; // Concession equals paid amount
//               }
//             }
//           }
//         }
...
//         // Include unpaid or partially paid past-due installments
...
export const UnpaidPastDueStudents = async (req, res) => {
  try {
    ...
    // Fetch students with TCStatus included
