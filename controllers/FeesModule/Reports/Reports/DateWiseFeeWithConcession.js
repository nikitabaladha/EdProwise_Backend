...
// //       {
// //         $facet: {
// //           // For School Fees - break down by individual fee types
// //           schoolFeesRefunds: [
...
// //           // For other fee types - use refundType directly
// //           otherFeesRefunds: [
// //             {
// //               $match: {
// //                 refundType: {
...
// //                   receiptNumber: '$receiptNumber',
// //                   installmentName: '$installmentName',
// //                   refundType: '$refundType', // Include refundType in grouping
// //                 },
...
// //               $addFields: {
// //                 academicYear: '$_id.academicYear',
// //                 feeTypeName: '$_id.refundType', // Use the refundType directly
// //                 installmentName: '$_id.installmentName',
// //               },
// //             },
// //           ],

// //           // For School Fees without feeTypeRefunds (fallback)
...
//              $cond: [
//                 { $eq: ['$_id.status', 'Paid'] },
//                 { $ad: ['$feeItems.paid', { $ifNull: ['$feeItems.concession', 0] }] },
//                 '$feeItems.cancelledPaidAmount',
//               ],
//             },
//           },
...
//               }
//             },
//             // Distribute fine and excess amounts proportionally to fee types
//             feeFineAmount: {
//               $multiply: [
//                 '$fineAmountToUse',
//                 {
...
//             fineAmount: { $sum: '$feeFineAmount' }, // Track fine amount
//             excessAmount: { $sum: '$feeExcessAmount' }, // Track excess amount
//             feeTypeName: { $first: '$feeTypeData.feesTypeName' },
//           },
//         },
//         {
...
//       // For other fee types - use refundType directly WITH FINE AND EXCESS
//       otherFeesRefunds: [
//         {
//           $match: {
//             refundType: {
...
//               //   if: { $eq: ['$status', 'Refund'] },
//               //   then: {
//               //     $subtract: ['$refundAmount', '$concessionAmount']
//               //   },
//               //   else: '$cancelledAmount'
//               // }
...
//     then: '$refundAmount',
//     else: {
//       $subtract: ['$cancelledAmount', { $ifNull: ['$concessionAmount', 0] }]
//     }
//             },
//             // Include fine and excess amounts for other fee types
...
//             fineAmount: { $sum: '$fineAmount' }, // Track fine amount
//             excessAmount: { $sum: '$excessAmount' }, // Track excess amount
//           },
//         },
//         {
//           $addFields: {
...
//       // For School Fees without feeTypeRefunds (fallback) WITH FINE AND EXCESS
//       schoolFeesWithoutBreakdown: [
//         { $match: { refundType: 'School Fees', feeTypeRefunds: { $eq: [] } } },
//         {
//           $addFields: {
...
//               }
//             },
//             // Include fine and excess amounts
//             fineAmount: '$fineAmountToUse',
//             excessAmount: '$excessAmountToUse'
//           }
//         },
