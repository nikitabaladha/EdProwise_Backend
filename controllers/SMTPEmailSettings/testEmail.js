...
const testEmail = async (req, res) => {
  try {
    ...
    const isSSL =
      smtpSettings.mailEncryption === "SSL" && smtpSettings.mailPort == "465";
    const isTLS =
      smtpSettings.mailEncryption === "TLS" && smtpSettings.mailPort == "587";
    ...
    return res
      .status(200)
      .json({ hasError: false, message: "Test email sent successfully!" });
  } catch (error) {
