...
const SellerProfileCreateValidator = Joi.object({
  ...
  .messages({
    ...
    "string.pattern.base": "Bank Account number must only contain digits and be between 8 and 16 digits long.",
  ...
  .messages({
    ...
    "string.pattern.base": "IFSC must follow the pattern: 4 alphabetic characters, followed by '0', and 6 alphanumeric characters.",
