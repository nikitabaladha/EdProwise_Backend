...
export const RegistrationCreateValidator = Joi.object({
  ...
  nationality: Joi.string()
    ...
    .messages({
      ...
      "any.only":
        "Nationality must be one of 'India', 'International', or 'SAARC Countries'.",
  ...
  studentCategory: Joi.string()
    ...
    .messages({
      "any.only":
        "Student category must be one of 'General', 'OBC', 'ST', 'SC'.",
      "any.required": "Student category is required.",
    }),
  howReachUs: Joi.string()
    .valid("Teacher", "Advertisement", "Student", "Online Search")
    .required()
    .messages({
      "any.only":
        "This field must be one of 'Teacher', 'Advertisement', 'Student', 'Online Search'.",
